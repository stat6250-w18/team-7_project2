...
in "TOTAL" between Eth_grad_1415 and Eth_grad_1516?
Rationale: This should help identify schools, which may can accommodate more 
students based upon increasing total graduated numbers.
...
proc sort
    ...
    ;
    by descending TOTAL_change_2014_to_2015;
run;
...
*
Question: What are the top five schools that experienced the biggest increase
in "TWO_MORE_RACES" between Eth_grad_1415 and Eth_grad_1516?
Rationale: This would help inform the schools, whihc would like the 
international schools and can attractive more internaional students to enroll 
the schools.
...
proc sort
        ...
        out=Eth_grad_1415_file_sorted
    ;
    by descending TWO_MORE_RACES_change_2014_to_2015;
run;
...
*******************************************************************************;
*
Question: What are the top ten schools were the minimum numbers of 
dropouts15-16 with higest enrollment15-16 numbers?
Rationale: This would help identify schools with significant performance of 
education level can keep more stduents until graduated.
